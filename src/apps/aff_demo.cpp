...
//{
//    int              maxTilt        = -1;
//    float            threshold      = 0.9;  // matching threshold
...
//
//    resize(im1, im1, Size(im1.cols / 1.5, im1.rows / 1.5));
//    resize(im2, im2, Size(im2.cols / 1.5, im2.rows / 1.5));
//
//
...
//    resize(imgMatches, imgMatches, Size(imgMatches.cols / 2, imgMatches.rows));
