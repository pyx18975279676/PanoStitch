...
void max_u_v(float *u,float *v,int size) { for(int i=0;i<size;i++)  u[i]=fmax(u[i],v[i]);}

void max_u_k(float *u, float k, int size) { for(int i=0;i<size;i++)  u[i]=fmax(u[i],k);}

void min_u_v(float *u, float *v,int size) { for(int i=0;i<size;i++)  u[i]=fmin(u[i],v[i]);}

void min_u_k(float *u,float k,int size) { int i=0; for(i=0;i<size;i++)  u[i]=fmin(u[i],k);}
